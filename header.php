...
<head>
    ...
    <meta name="author" content="Ayaz Ahmed Mast">
    <meta name="keywords" content="Laptop, dell, hp, lenovo, asus ">
    <!-- FAVICONS -->
    <link rel="shortcut icon" href="<?php echo ot_get_option('favicon'); ?>" type="image/x-icon">
    <link rel="apple-touch-icon" sizes="76x76" href="<?php echo ot_get_option('favicon'); ?>">
